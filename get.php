...
// TODO: use jQuery FullCalendar plugin to display the events in a proper calendar - momentjs.com/docs/#/displaying
// calendar has to have at least month, week and day views
// timeformat is 24-hour clock    
// when an event is clicked all the event details (jsonEvents) are displayed //	moment().format("HH:mm:ss"); 
